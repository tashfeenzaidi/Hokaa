...
class MainScreen extends StatelessWidget {
        ...
        body: Container(
          ...
          child: SafeArea(
            child: _controller.obx(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                        image: NetworkImage(event[index].imageUrl!),
                                        fit: BoxFit.cover)),
                                child: Align(
                                        ...
                                        children: [
                                          ...
                                          Wrap(
                                            ...
                                            children: [
                                              Text(
                                                Utils.getDate(
                                                    DateTime.parse(event[index].createdAt!)),
              ...
              onEmpty: getWidget(context),
              onError: (e) => getErrorWidget(e!),
  ...
  Widget getErrorWidget(String e){
